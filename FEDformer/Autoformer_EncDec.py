...
class Auto_EncoderLayer(nn.Module):
    """
    Autoformer encoder layer with the progressive decomposition architecture
    """
    def __init__(self, attention, d_model, moving_avg=25, dropout=0.1, activation="relu", projection=None, trend=True):
        super(Auto_EncoderLayer, self).__init__()
        d_ff = 4 * d_model
...
class Auto_Encoder(nn.Module):
    ...
    def forward(self, x, trend=None, attn_mask=None):
        attns = []
...
class Auto_DecoderLayer(nn.Module):
    """
    Autoformer decoder layer with the progressive decomposition architecture
    """
    def __init__(self, self_attention, cross_attention=None, d_model=512, c_out=7,
                 moving_avg=25, dropout=0.1, activation="relu"):
        super(Auto_DecoderLayer, self).__init__()
        d_ff = 4 * d_model
...
class Auto_Decoder(nn.Module):
    ...
    def forward(self, x, cross=None, x_mask=None, cross_mask=None, trend=None):
