...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.inverse:
            self.data_y = df_value[border1:border2]
        else:
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 freq='h', cols=None, criterion='Standard'):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
...
class Dataset_WTH(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='WetBulbCelsius', scale=True, inverse=False, timeenc=0,
                 freq='h', cols=None, criterion='Standard'):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
    ...
    def __read_data__(self):
        ...
        if self.cols:
            ...
            cols.remove(self.target)
            cols.remove('date')
            cols.remove('Visibility')
            cols.remove('DewPointFarenheit')
            cols.remove('DewPointCelsius')
            cols.remove('WindSpeed')
            cols.remove('WindDirection')
            cols.remove('StationPressure')
            cols.remove('Altimeter')
